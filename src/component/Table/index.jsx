...
const Table = ({ editarCategoria }) => {
  ...
  useEffect(() => {
    fetchData(catsUrl)
      ...
      .then(
        console.log(
          "%cTabla cargada con éxito",
          "color: green; font-weight: bold; text-shadow: 0.5px 0.5px 0.5px gray;"
        )
      )
  ...
  const handleRemove = async (id) => {
    try {
      ...
      console.log(
        "%cCategoria eliminada con éxito",
        "color: green; font-weight: bold; text-shadow: 0.5px 0.5px 0.5px gray;"
      );
      ...
      <tbody>
        {data.map((categoria) => (
          <tr key={categoria.id}>
            ...
            <TdCSS>
              <a href="#" onClick={() => handleRemove(categoria.id)}>
                Eliminar
              </a>
            </TdCSS>
          </tr>
      ...
      <tbody>
        {data.map((video) => (
          <tr key={video.id}>
            ...
            <TdCSS>
              <a href="#" onClick={() => editarVideo(video.id)}>
                Editar
              </a>
            </TdCSS>
            <TdCSS>
              <a href="#" onClick={() => handleRemove(video.id)}>
                Eliminar
              </a>
            </TdCSS>
          </tr>
